...
#using imf time series to predict the next time step dst value
samples = pickle.load(open("imf_inp.pkl", "rb"))
...
lstm_cells = [LSTMCell(HIDDEN_SIZE, forget_bias=1.0, use_peepholes=True, activation=tf.nn.relu) for i in range(N_LAYERS)]
...
'''
with shuffle
train_loss: 343.755, test_loss: 340.645

without shuffle
train_loss: 355.435, test_loss: 320.269
'''        
